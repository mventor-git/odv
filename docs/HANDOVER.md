...
Current: no active ticket; 001-015 pushed @76b95a2 (2026-09-16; typecheck clean, smoke 45/45 re-verified pre-push)
...
Next: 016 end-to-end vertical slice per §21 (handoff roadmap) — only on human order
